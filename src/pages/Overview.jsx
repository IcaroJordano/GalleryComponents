...
export function Overview() {
    ...
    const {componentsFiltered,isLoading,idFilter} = useContext(SearchContext)
    ...
    return (
        <section className="w-9/12 mx-auto min-h-screen mt-20 lg:mt-8">
            ...
            <h2 className="flex text-2xl items-center text-neutral-700" >{idFilter} <div className="border rounded-md text-center  ms-2 border-neutral-400 flex items-center justify-center  text-sm w-5 lg:w-6 h-5 lg:h-6">{componentsFiltered.length}</div></h2>
